<%@ Page Title="" Language="C#" MasterPageFile="~/CapaPresentacion/Master/PaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="EliminarSeccion.aspx.cs" Inherits="Sistema_Fundanet.CapaPresentacion.ModSecciones.EliminarSeccion" %>
       ...
       <td style="width: 100px">
        ...
        <td style="width: 100px">
            ...
            <table style="width:50%; text-align:center;">
                <tr>
                    <td colspan="4">
                        <asp:Label ID="LabelTitulo" runat="server" CssClass="MiLabel" Font-Bold="True" Font-Names="Candara" Font-Size="Larger" Text="Eliminar Sección"></asp:Label>
                        <br />
                        <br />
                    </td>
                </tr>              
                ...
                <tr>
                  ...
                  <tr>
                      <td colspan="2">
                        <asp:Button ID="BEliminar" runat="server" Text="Eliminar" Width="95px" OnClick="BEliminar_Click"/> 
                    </td>
                    <td colspan="2">
