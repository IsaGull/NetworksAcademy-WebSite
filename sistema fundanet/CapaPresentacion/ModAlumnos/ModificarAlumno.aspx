<%@ Page Title="" Language="C#" MasterPageFile="~/CapaPresentacion/Master/PaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="ModificarAlumno.aspx.cs" Inherits="Sistema_Fundanet.CapaPresentacion.ModAlumnos.ModificarAlumno" %>
  ...
  <table >
        ...
        <tr>
            ...
            <td width="430" height="307" class="imagen2" rowspan="2">
                ...
                <img src="../Imagenes/ModificarAlumno.png" class="img" />
            </td>
            ...
            <td style="width: 454px">
                ...
                <table style="width:100%; text-align:center;">
                    <tr>
                        <td colspan="2" style="width: 42%" > <asp:Label ID="Label2" runat="server" Text="Consultar Alumno" CssClass="MiLabel" Font-Bold="True" Font-Names="Candara" Font-Size="Larger"></asp:Label>
                            <br />
                            <br />
                        </td>
                     ...
                     <tr>
                        <td colspan="1" style="width: 42%" > <asp:Label ID="Label1" runat="server" Text="Cedula del Estudiante:" CssClass="MiLabel" Font-Bold="True" Font-Names="Candara" Font-Size="Medium"></asp:Label></td>
                        <td> 
                            <br />
