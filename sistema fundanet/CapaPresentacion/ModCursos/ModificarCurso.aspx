<%@ Page Title="" Language="C#" MasterPageFile="~/CapaPresentacion/Master/PaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="ModificarCurso.aspx.cs" Inherits="Sistema_Fundanet.CapaPresentacion.ModCursos.ModificarCurso" %>
            ...
            <td width="430" height="307" class="imagen2" rowspan="2">
             ...
             <td style="width: 454px">
                  ...
                  <table style="width:100%; text-align:center;">
                      <tr>
                        <td colspan="4" style="width: 42%" > <asp:Label ID="LabelTitulo" runat="server" Text="Modificar Curso" CssClass="MiLabel" Font-Bold="True" Font-Names="Candara" Font-Size="Larger"></asp:Label>
                            <br />
                            <br />
                            <br />
                        </td>
                      ...
                      <tr >
                           <td colspan="4" style="width: 100%" >
                             <br />                       
                             <asp:Button ID="BModificar" runat="server" Text="Modificar" Width="90px" OnClick="BModificar_Click" />   
